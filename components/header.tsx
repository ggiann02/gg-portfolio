  ...
  return (
    <header className="relative">
      <div className="flex items-center justify-between px-6 py-8 md:px-12">
        ...
        {/* Mobile Menu Button & Resume */}
        <div className="flex md:hidden items-center gap-4">
          <Link href="/resume" onClick={closeMenu}>
            <Button
              variant="outline"
              className="border-black text-black hover:bg-black hover:text-white bg-transparent text-xs px-3 py-2"
              style={{ fontFamily: "var(--font-ibm-plex-sans)" }}
            >
              RESUME
            </Button>
          ...
          <nav className="flex flex-col p-6 space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              >
                ...
                <span className="text-sm font-medium" style={{ fontFamily: "var(--font-ibm-plex-sans)" }}>
                  LinkedIn
                </span>
              </a>
            </div>
